    ...
    for cond in bp_coverages_dict:
        ...
        for cvg in bp_coverages_dict[cond]:
            ...
            for pos in fit_region_to_iterate:
                ...
                if(up_end - up_start < min_coverage_region):
        ...
        if isinstance(site[0], list):
            ...
            for subsite in site:
                ...
                for cond in valid_conds_list:
                    ...
                    # print('|'.join([str(elem) for elem in valid_ratios])+', '+str(curr_best_median_ratio))
...
def get_pA_set(exon_id, 
    ...
    # (if the distal site comes from a set of closely spaced sites
    ...
    if len(used_sites) > 1:
        ...
        # iterate over all other sites except the most proximal one (if such sites are available)
...
def main(options):
    ...
    # clusters are expected to be sorted proximal -> distal irrespective of strand!!!
    ...
    for exon in terminal_exons_dict:
        ...
        for cond in coverage_pkl_dict:
            ...
            for cvg in coverage_pkl_dict[cond]:
                ...
                if np.mean(curr_cov_arr)>options.min_mean_coverage:

            ...
            for cvg in bp_coverages_dict[cond]:
                ...
                if strand == "+":
                    ...
                    try:
                        ...
                        up_start_idx = region.index(site[1].end - 1) # Aleksei: I try this to resolve an error
...
def main(options):
    ...
    for sample_id in options.sample_names:
        ...
        for cov_file_path in cov_file_path_list:
            if sample_id+".pkl" in cov_file_path and cov_file_path.endswith(".pkl"):
                ...
                for tmp_file in ext_file_path_list:
                    if sample_id+".extensions.tsv" in tmp_file and tmp_file.endswith("extensions.tsv"):
        ...
        if pkl_file=='':
            ...
            sys.exit(2)            
        syserr("[INFO] pkl file "+pkl_file+" found for" +sample_id+"\n")
